...
int id_duenio, std::pair<int, int> centro, Config &config) {
	if(id_tipo_unidad_movible == INFANTERIA_LIGERA) {
		std::shared_ptr<InfanteriaLigera> infanteria_ligera(
		new InfanteriaLigera(id, id_duenio, centro, config));
